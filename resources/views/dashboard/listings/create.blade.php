        ...
        <div class="bg-white rounded-2xl border border-slate-200 p-6">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="title" id="title" value="{{ old('title') }}" required class="w-full rounded-xl border-slate-200 text-sm focus:border-primary focus:ring-primary py-3" placeholder="e.g., Luxury Beachfront Villa with Pool">
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="4" class="w-full rounded-xl border-slate-200 text-sm focus:border-primary focus:ring-primary" placeholder="Describe your listing in detail...">{{ old('description') }}</textarea>
                ...
                <div>
                    ...
                    <input type="number" name="price" id="price" value="{{ old('price') }}" class="w-full rounded-xl border-slate-200 text-sm focus:border-primary focus:ring-primary py-3" placeholder="e.g., 25000" step="0.01">
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-200 p-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="phone" value="{{ old('phone') }}" class="w-full rounded-xl border-slate-200 text-sm focus:border-primary focus:ring-primary py-3" placeholder="9876543210">
                </div>
                <div>
                    <label class="block text-sm font-bold text-slate-700 mb-1.5">WhatsApp</label>
                    <input type="text" name="whatsapp" value="{{ old('whatsapp') }}" class="w-full rounded-xl border-slate-200 text-sm focus:border-primary focus:ring-primary py-3" placeholder="9876543210">
                </div>
                <div>
                    <label class="block text-sm font-bold text-slate-700 mb-1.5">Email</label>
                    <input type="email" name="email" value="{{ old('email') }}" class="w-full rounded-xl border-slate-200 text-sm focus:border-primary focus:ring-primary py-3">
                </div>
                <div>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 gap-3">
                @foreach($amenities as $amenity)
                    <label class="flex items-center gap-2 p-3 rounded-xl border border-slate-200 cursor-pointer hover:border-primary/30 has-[:checked]:bg-primary/5 has-[:checked]:border-primary/30 transition-colors">
                        <input type="checkbox" name="amenities[]" value="{{ $amenity->id }}" class="rounded border-slate-300 text-primary focus:ring-primary">

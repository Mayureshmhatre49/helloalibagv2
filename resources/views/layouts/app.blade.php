            ...
            <div class="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 relative">
                <div class="flex items-center h-16 gap-4">
                    ...
                    <a href="{{ route('home') }}" class="flex items-center flex-shrink-0 mr-2 group">
                        <img src="{{ asset('images/helloalibaug-logo.png') }}" alt="Hello Alibaug — Discover, Stay, Eat" class="h-9 sm:h-11 w-auto">
                    </a>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
                ...
                <div class="md:col-span-1">
                    <a href="{{ route('home') }}" class="flex items-center mb-4 group">
                        <img src="{{ asset('images/helloalibaug-logo.png') }}" alt="Hello Alibaug — Discover, Stay, Eat" class="h-11 w-auto">
                    </a>

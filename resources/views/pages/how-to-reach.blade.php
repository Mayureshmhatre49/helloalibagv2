        ...
        <article class="bg-white border border-border-light rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-shadow">
            ...
            <div class="p-6">
                ...
                <div class="bg-blue-50 border border-blue-100 rounded-xl p-4 text-xs text-blue-900 mt-4 leading-relaxed">
                    <strong class="font-bold">Pro tip:</strong> Book M2M or RoRo tickets online during weekends — last ferry from Mandwa departs around 6:00 PM. Monsoon (June–Sep) ferries are often suspended.
                </div>
            </div>
        </article>
        ...
        <div class="grid lg:grid-cols-[1fr_400px] gap-10 items-start">
            <div>
                ...
                <p class="text-slate-600 text-base leading-relaxed mb-6">
                    Three operators run scheduled ferries between Gateway of India and Mandwa Jetty year-round (weather permitting). Mandwa is a 20-minute drive from Alibaug town.
                </p>

                {{-- Operator table --}}
                <div class="bg-slate-50 border border-border-light rounded-2xl overflow-hidden">
                    <table class="w-full text-sm">
                        <thead class="bg-slate-100">
                            <tr>
                                <th class="text-left px-4 py-3 font-bold text-slate-700 text-xs uppercase tracking-wider">Operator</th>
                                <th class="text-left px-4 py-3 font-bold text-slate-700 text-xs uppercase tracking-wider">Type</th>
                                <th class="text-left px-4 py-3 font-bold text-slate-700 text-xs uppercase tracking-wider">Hours</th>
                                <th class="text-right px-4 py-3 font-bold text-slate-700 text-xs uppercase tracking-wider">Price</th>
                            </tr>
                        </thead>
                        <tbody class="bg-white divide-y divide-border-light">
                            <tr>
                                <td class="px-4 py-3">
                                    <p class="font-bold text-slate-900">M2M Ferry</p>
                                    <p class="text-text-secondary text-xs">High-speed catamaran</p>
                                </td>
                                <td class="px-4 py-3 text-text-secondary">Air-conditioned</td>
                                <td class="px-4 py-3 text-slate-700 font-medium tabular-nums">7:00 AM – 6:00 PM</td>
                                <td class="px-4 py-3 text-right text-slate-900 font-bold tabular-nums">₹250–₹350</td>
                            </tr>
                            <tr>
                                <td class="px-4 py-3">
                            ...
                            <tr>
                                <td class="px-4 py-3">
                                    <p class="font-bold text-slate-900">RoRo Ferry</p>
                                    <p class="text-text-secondary text-xs">Cars + passengers</p>
                                </td>
                                <td class="px-4 py-3 text-text-secondary">Vehicle ferry</td>
                                <td class="px-4 py-3 text-slate-700 font-medium tabular-nums">7:00 AM – 7:00 PM</td>
                                <td class="px-4 py-3 text-right text-slate-900 font-bold tabular-nums">₹1,200–₹2,500</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <aside class="space-y-4">
                ...
                <div class="bg-gradient-to-br from-emerald-50 to-teal-50 border border-emerald-200 rounded-2xl p-5">
                    ...
                    <p class="text-slate-700 text-xs leading-relaxed">Book M2M or RoRo tickets online via their apps. Walk-ins are accepted at the jetty but weekends and holidays can see 30–45 minute waits.</p>
                </div>

...
<div class="max-w-2xl">
    ...
    <div class="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
        ...
        <form method="POST" action="{{ route('admin.seo.update', $listing) }}" class="space-y-5">
            ...
            <div>
                <label class="block text-sm font-bold text-slate-700 mb-1.5">Meta Title <span class="text-xs text-slate-400 font-normal">(max 70 chars — becomes the &lt;title&gt; and social title)</span></label>
            ...
            <div>
                <label class="block text-sm font-bold text-slate-700 mb-1.5">Social Image URL <span class="text-xs text-slate-400 font-normal">(og:image — 1200×630 recommended)</span></label>
            ...
            <div>
                <label class="block text-sm font-bold text-slate-700 mb-1.5">Canonical URL <span class="text-xs text-slate-400 font-normal">(optional — only if this content lives elsewhere)</span></label>
            ...
            <div>
                <label class="block text-sm font-bold text-slate-700 mb-1.5">Keywords <span class="text-xs text-slate-400 font-normal">(comma-separated)</span></label>

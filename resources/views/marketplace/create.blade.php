@extends('layouts.app')
@section('title', 'Sell an item — Alibaug Marketplace')
...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="mb-6">
        ...
        <h1 class="text-3xl font-bold text-text-main">Sell an item</h1>
        <p class="text-text-secondary mt-1">It's free to list. Your item goes live after a quick review by our team.</p>
    </div>

    <form method="POST" action="{{ route('marketplace.store') }}" enctype="multipart/form-data" class="bg-white rounded-2xl border border-border-light p-6">
        @csrf
